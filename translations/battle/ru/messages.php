...
return [
    ...
    '%s use %s %s and <i>crushing</i> hit for %d damage against %s'          => '%s использовал %s %s и нанес <i>сокрушительный</i> удар на %d урона по %s',
    // $unit use $icon $ability and hit for unlucky $damage damage against $targets
    '%s use %s %s and <i>unlucky</i> hit for %d damage against %s'           => '%s использовал %s %s и нанес <i>неудачный</i> удар на %d урона по %s',
    ...
    '%s use %s %s and <i>crushing</i> critical hit for %d damage against %s' => '%s использовал %s %s и нанес <i>сокрушительный</i> критический удар на %d урона по %s',
    // $unit use $icon $ability and unlucky critical hit for $damage damage against $targets
    '%s use %s %s and <i>unlucky</i> critical hit for %d damage against %s'  => '%s использовал %s %s и нанес <i>неудачный</i> критический удар на %d урона по %s',
