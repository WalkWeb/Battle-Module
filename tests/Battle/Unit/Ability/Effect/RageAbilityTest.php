...
class RageAbilityTest extends AbstractUnitTest
{
    ...
    /**
     * Тест на создание способности RageAbility через универсальный объект Ability
     *
     * @throws Exception
     */
    public function testNewRageAbilityCreate(): void
    {
        $name = 'Rage';
        $icon = '/images/icons/ability/285.png';
     ...
     * @throws Exception
     */
    public function testNewRageAbilityCanByUsed(): void
    {
        $unit = UnitFactory::createByTemplate(31);
        $enemyUnit = UnitFactory::createByTemplate(2);
        $command = CommandFactory::create([$unit]);
