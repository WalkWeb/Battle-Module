...
class AvengerPrimordialFormAbilityTest extends AbstractUnitTest
{
    ...
    /**
     * Тест на создание способности Avenger Primordial Form через AbilityDataProvider
     *
     * @throws Exception
     */
    public function testAvengerPrimordialFormAbilityCreate(): void
    {
        $name = 'Avenger Primordial Form';
    ...
    /**
     * Тест на применение способности Avenger Primordial Form
     *
     ...
     * @throws Exception
     */
    public function testAvengerPrimordialFormAbilityUse(
        int $level,
