...
class SparePotionAbilityTest extends AbstractTestCase
{
    private const string MESSAGE_EN = '<span style="color: #1e72e3">unit_4</span> use <img src="/images/icons/ability/299.png" alt="" /> <span class="ability">Spare Potion</span> on <span style="color: #1e72e3">wounded_unit</span>';
    private const string MESSAGE_RU = '<span style="color: #1e72e3">unit_4</span> использовал <img src="/images/icons/ability/299.png" alt="" /> <span class="ability">Запасное зелье</span> на <span style="color: #1e72e3">wounded_unit</span>';

    private const string MESSAGE_EFFECT_EN = '<span style="color: #1e72e3">wounded_unit</span> restored %d life from effect <img src="/images/icons/ability/299.png" alt="" /> <span class="ability">Spare Potion</span>';
    private const string MESSAGE_EFFECT_RU = '<span style="color: #1e72e3">wounded_unit</span> восстановил %d здоровья от эффекта <img src="/images/icons/ability/299.png" alt="" /> <span class="ability">Запасное зелье</span>';
