...
class BleedingWoundAbilityTest extends AbstractTestCase
{
    private const string MESSAGE_EN = '<span style="color: #1e72e3">100_dodge</span> use <img src="/images/icons/ability/229.png" alt="" /> <span class="ability">Bleeding Wound</span> and hit for %d damage against <span style="color: #1e72e3">unit_2</span>';
    private const string MESSAGE_RU = '<span style="color: #1e72e3">100_dodge</span> использовал <img src="/images/icons/ability/229.png" alt="" /> <span class="ability">Кровоточащая рана</span> и нанес удар на %d урона по <span style="color: #1e72e3">unit_2</span>';

    private const string MESSAGE_EFFECT_EN = '<span style="color: #1e72e3">unit_2</span> received %d damage from effect <img src="/images/icons/ability/229.png" alt="" /> <span class="ability">Bleeding Wound</span>';
    private const string MESSAGE_EFFECT_RU = '<span style="color: #1e72e3">unit_2</span> получил %d урона от эффекта <img src="/images/icons/ability/229.png" alt="" /> <span class="ability">Кровоточащая рана</span>';
