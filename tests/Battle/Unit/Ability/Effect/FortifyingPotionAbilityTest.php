...
class FortifyingPotionAbilityTest extends AbstractAbilityTest
{
     ...
     * @throws Exception
     */
    public function testFortifyingPotionAbilityCreate(): void
    {
    ...
    public function testFortifyingPotionAbilityUse(int $level, int $expectedPower, int $expectedEffectDuration): void
    {
        ...
        $ability = $this->createAbilityByDataProvider($unit, 'Fortifying Potion', $level);
