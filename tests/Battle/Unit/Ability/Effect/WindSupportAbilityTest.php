...
class WindSupportAbilityTest extends AbstractTestCase
{
    private const string MESSAGE_EN = '<span style="color: #1e72e3">unit_4</span> use <img src="/images/icons/ability/442.png" alt="" /> <span class="ability">Wind Support</span>';
    private const string MESSAGE_RU = '<span style="color: #1e72e3">unit_4</span> использовал <img src="/images/icons/ability/442.png" alt="" /> <span class="ability">Поддержка ветра</span>';
