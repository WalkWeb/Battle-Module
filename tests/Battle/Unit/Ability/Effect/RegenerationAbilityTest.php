...
class RegenerationAbilityTest extends AbstractAbilityTest
{
     ...
     * @throws Exception
     */
    public function testRegenerationAbilityCreate(): void
    {
        $name = 'Regeneration';
    ...
    public function testRegenerationAbilityUse(int $level, int $expectedPower, int $expectedEffectDuration): void
    {
        ...
        $ability = $this->createAbilityByDataProvider($unit, 'Regeneration', $level);
