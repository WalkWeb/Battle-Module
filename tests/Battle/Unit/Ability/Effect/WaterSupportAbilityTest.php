...
class WaterSupportAbilityTest extends AbstractAbilityTest
{
     ...
     * @throws Exception
     */
    public function testWaterSupportAbilityCreate(): void
    {
        $name = 'Water Support';
    ...
    public function testWaterSupportAbilityUse(int $level, int $expectedPower, int $expectedEffectDuration): void
    {
        ...
        $ability = $this->createAbilityByDataProvider($unit, 'Water Support', $level);
