...
class HandInjuryAbilityTest extends AbstractTestCase
{
    private const string MESSAGE_EN = '<span style="color: #1e72e3">unit_4</span> use <img src="/images/icons/ability/279.png" alt="" /> <span class="ability">Hand Injury</span> on <span style="color: #1e72e3">wounded_unit</span>';
    private const string MESSAGE_RU = '<span style="color: #1e72e3">unit_4</span> использовал <img src="/images/icons/ability/279.png" alt="" /> <span class="ability">Повреждение рук</span> на <span style="color: #1e72e3">wounded_unit</span>';
