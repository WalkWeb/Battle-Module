...
class WillToLiveAbilityTest extends AbstractUnitTest
{
    ...
    // TODO В будущем тесты на WillToLiveAbility будут удалены, и оставлены только тесты на аналогичный функционал
     ...
     * @throws Exception
     */
    public function testNewWillToLiveAbilityCreate(): void
    {
        $name = 'Will to live';
        $icon = '/images/icons/ability/429.png';
     ...
     * @throws Exception
     */
    public function testNewWillToLiveAbilityApply(): void
    {
        $unit = UnitFactory::createByTemplate(10);
        $enemyUnit = UnitFactory::createByTemplate(2);
        $command = CommandFactory::create([$unit]);
     ...
     * @throws Exception
     */
    public function testNewWillToLiveAbilityNoRepeatUsage(): void
    {
        $unit = UnitFactory::createByTemplate(10);
        $enemyUnit = UnitFactory::createByTemplate(12);
        $command = CommandFactory::create([$unit]);
