...
class HeavenlyJusticeAbilityTest extends AbstractAbilityTest
{
     ...
     * @throws Exception
     */
    public function testHeavenlyJusticeAbilityCreate(): void
    {
        $name = 'Heavenly Justice';
        $icon = '/images/icons/ability/388.png';
        $disposable = false;
    ...
    public function testHeavenlyJusticeAbilityUse(int $level, int $expectedDamage, int $expectedAccuracy): void
    {
        ...
        $ability = $this->createAbilityByDataProvider($unit, 'Heavenly Justice', $level);
