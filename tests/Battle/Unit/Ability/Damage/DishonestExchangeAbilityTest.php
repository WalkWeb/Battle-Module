...
class DishonestExchangeAbilityTest extends AbstractTestCase
{
    private const string MESSAGE_EN = '<span style="color: #1e72e3">unit_4</span> use <img src="/images/icons/ability/160.png" alt="" /> <span class="ability">Dishonest Exchange</span> and hit for %d damage against <span style="color: #1e72e3">unit_2</span> and restore %d life';
    private const string MESSAGE_RU = '<span style="color: #1e72e3">unit_4</span> использовал <img src="/images/icons/ability/160.png" alt="" /> <span class="ability">Нечестный обмен</span> и нанес удар на %d урона по <span style="color: #1e72e3">unit_2</span> и восстановил %d здоровья';
