...
class RageOfAncestorsAbilityTest extends AbstractTestCase
{
    private const string MESSAGE_EN = '<span style="color: #1e72e3">unit_4</span> use <img src="/images/icons/ability/073.png" alt="" /> <span class="ability">Rage of Ancestors</span> and hit for %d damage against <span style="color: #1e72e3">unit_2</span>';
    private const string MESSAGE_RU = '<span style="color: #1e72e3">unit_4</span> использовал <img src="/images/icons/ability/073.png" alt="" /> <span class="ability">Ярость предков</span> и нанес удар на %d урона по <span style="color: #1e72e3">unit_2</span>';

    /**
     * Тест на создание способности Rage of Ancestors через AbilityDataProvider
     *
     * @throws Exception
     */
    public function testRageOfAncestorsCreate(): void
    {
        $name = 'Rage of Ancestors';
        $icon = '/images/icons/ability/073.png';
        $disposable = false;
    ...
    /**
     * Тест на применение способности Rage of Ancestors
     *
     * @throws Exception
     */
    #[DataProvider('useDataProvider')]
    public function testRageOfAncestorsAbilityUse(
        int $level,
        int $expectedDamage,
