...
class PureEnergyAbilityTest extends AbstractTestCase
{
    private const string MESSAGE_EN = '<span style="color: #1e72e3">unit_5</span> use <img src="/images/icons/ability/282.png" alt="" /> <span class="ability">Pure Energy</span> and hit for %d damage against <span style="color: #1e72e3">unit_2</span>';
    private const string MESSAGE_RU = '<span style="color: #1e72e3">unit_5</span> использовал <img src="/images/icons/ability/282.png" alt="" /> <span class="ability">Чистая энергия</span> и нанес удар на %d урона по <span style="color: #1e72e3">unit_2</span>';
    ...
    public function testPureEnergyAbilityUse(int $level, int $expectedDamage, int $expectedAccuracy): void
    {
        ...
        $ability = $this->getAbility($unit, 'Pure Energy', $level);
