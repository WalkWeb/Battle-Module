...
class ArmorPiercingBoltAbilityTest extends AbstractTestCase
{
    private const string MESSAGE_EN = '<span style="color: #1e72e3">small_wounded_unit</span> use <img src="/images/icons/ability/006.png" alt="" /> <span class="ability">Armor Piercing Bolt</span> and hit for %d damage against <span style="color: #1e72e3">unit_2</span>';
    private const string MESSAGE_RU = '<span style="color: #1e72e3">small_wounded_unit</span> использовал <img src="/images/icons/ability/006.png" alt="" /> <span class="ability">Бронебойный болт</span> и нанес удар на %d урона по <span style="color: #1e72e3">unit_2</span>';
    ...
    public function testArmorPiercingBoltAbilityUse(int $level, int $expectedDamage, int $expectedAccuracy): void
    {
        ...
        $ability = $this->getAbility($unit, 'Armor Piercing Bolt', $level);
