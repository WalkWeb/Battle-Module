...
class TouchOfVoidAbilityTest extends AbstractTestCase
{
    private const string MESSAGE_EN = '<span style="color: #1e72e3">unit_4</span> use <img src="/images/icons/ability/310.png" alt="" /> <span class="ability">Touch of Void</span> and hit for %d damage against <span style="color: #1e72e3">unit_2</span>';
    private const string MESSAGE_RU = '<span style="color: #1e72e3">unit_4</span> использовал <img src="/images/icons/ability/310.png" alt="" /> <span class="ability">Прикосновение пустоты</span> и нанес удар на %d урона по <span style="color: #1e72e3">unit_2</span>';
    ...
    public function testTouchOfVoidAbilityUse(int $level, int $expectedDamage, int $expectedAccuracy, int $expectedCriticalChance): void
    {
        ...
        $ability = $this->getAbility($unit, 'Touch of Void', $level);
