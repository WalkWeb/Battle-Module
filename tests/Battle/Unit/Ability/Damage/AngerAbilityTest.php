...
class AngerAbilityTest extends AbstractTestCase
{
    private const string MESSAGE_EN = '<span style="color: #1e72e3">unit_1</span> use <img src="/images/icons/ability/523.png" alt="" /> <span class="ability">Anger</span> and hit for %d damage against <span style="color: #1e72e3">unit_2</span>';
    private const string MESSAGE_RU = '<span style="color: #1e72e3">unit_1</span> использовал <img src="/images/icons/ability/523.png" alt="" /> <span class="ability">Гнев</span> и нанес удар на %d урона по <span style="color: #1e72e3">unit_2</span>';
