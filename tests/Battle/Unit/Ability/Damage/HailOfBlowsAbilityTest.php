...
class HailOfBlowsAbilityTest extends AbstractTestCase
{
    private const string MESSAGE_EN = '<span style="color: #1e72e3">unit_1</span> use <img src="/images/icons/ability/249.png" alt="" /> <span class="ability">Hail of Blows</span> and hit for %d damage against <span style="color: #1e72e3">unit_2</span>';
    private const string MESSAGE_RU = '<span style="color: #1e72e3">unit_1</span> использовал <img src="/images/icons/ability/249.png" alt="" /> <span class="ability">Град ударов</span> и нанес удар на %d урона по <span style="color: #1e72e3">unit_2</span>';
    ...
    public function testHailOfBlowsAbilityUse(int $level, int $expectedDamage, int $expectedAccuracy, int $expectedCriticalChance): void
    {
        ...
        $ability = $this->getAbility($unit, 'Hail of Blows', $level);
