...
- [Ошибка] Если юнит совершает две атаки за ход, а цель умерла после первой атаки, то вторая наносится по ней же, хотя
должна наноситься по следующей живой цели
...
- Добавить показатель DPS - средний урон за один ход
