...
- Добавить README по параметрам js-анимаций, а то уже сам начинаю забывать, какой параметр за что отвечает.
...
- Добавление одного параметра юниту приводит к правке 19 файлов, в основном это тесты. Необходимо по-максимому 
использовать в тестах `Tests\Battle\Factory\UnitFactory`, чтобы уменьшить количество необходимых правок.
