...
- Переделать механику DamageAction таким образом, чтобы можно было устанавливать любую силу удара
- Изменить механику использования способностей, реализовав их через паттерн Observer, когда сама способность будет
следить за изменениями персонажа, и в случае необходимости активироваться. Это позволит делать активацию способностей
очень гибкой, а не завязанной только на концентрацию и ярость.
