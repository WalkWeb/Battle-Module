...
- Рандомизатор урона не должен влиять на урон от эффектов
- Иконкам эффектов добавить описание через <abbr>
- Добавить приписку удачный/неудачный удар при критически высоком или критически низком множителе урона
...
наиболее актуальная
- Добавить все способности из первой версии боевой системы
- Реализовать все варианты классов из первой версии боевой системы
...
- Добавить особый тип способности, когда юнит может создавать копию себя, с % от своих характеристик, и с опцией, 
копировать или нет способности. В случае копирования способностей, копии также смогут вызывать свои копии
- Добавить механику, при которой способностям в требованиях можно указывать не только наличие определенного типа оружия, 
но и наличие надетого щита
- И многое другое
...
- [x] `damage multiplier` – Общий множитель наносимого урона
...
- [x] `dodge` – Уклонение. Вероятность избежать удара или заклинания противника. Не зависит от меткости противника
...
ярость
- [x] `add concentration multiplier` – Множитель получаемой концентрации
- [x] `cunning multiplier` – Множитель хитрости
- [x] `add rage multiplier` – Множитель получаемой ярости
...
- [x] `vampirism` – Позволяет воровать часть нанесенного урона в здоровье
- [x] `magic vampirism` – Позволяет воровать часть нанесенного урона в ману

Всего 60 характеристик. Вместе с гибкой [системой эффектов](https://github.com/WalkWeb/Battle-Module/tree/master/src/Battle/Unit/Effect) 
