...
- Статистика лечения от эффектов сейчас засчитывается некорректно - лечение засчитывается тому, на ком находится эффект,
а не тому, кто этот эффект создал.
- Реализовать механику применения эффекта на всю команду.
