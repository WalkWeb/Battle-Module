...
trait ValidationTrait
{
     ...
     * @throws BattleException
     */
    protected static function floatOrDefault(array $data, string $filed, float $default, string $error): float
    {
        if (!array_key_exists($filed, $data)) {
            return $default;
        }

        if (!is_float($data[$filed])) {
            throw new BattleException($error);
        }
     ...
     * @throws BattleException
     */
    protected static function boolOrDefault(array $data, string $filed, bool $default, string $error): bool
    {
        if (!array_key_exists($filed, $data)) {
            return $default;
        }
     ...
     * @throws BattleException
     */
    protected static function arrayIntOrNull(array $data, string $filed, string $error): array
    {
        if (!array_key_exists($filed, $data)) {
            return [];
        }
