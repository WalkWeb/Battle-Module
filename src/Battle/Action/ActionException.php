...
class ActionException extends Exception
{
    ...
    public const INVALID_OFFENSE_DATA        = 'ActionFactory: Invalid offense data: array expected';
    ...
    public const INVALID_ANIMATION_DATA      = 'ActionFactory: Invalid animation_name data: string expected';
    ...
    public const INVALID_MESSAGE_METHOD      = 'ActionFactory: invalid message_method: string expected';
